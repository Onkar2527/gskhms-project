...
export class AllpatientsComponent
  ...
  editCall(row: Patient) {
    ...
    let tempDirection: Direction;
    this.router.navigate(['/admin/patients/edit-patient'], { queryParams: { userId: this.patientId } });
  ...
  exportExcel() {
    ...
    const exportData: Partial<TableElement>[] =
      this.dataSource.filteredData.map((x) => ({
        ...
        Gender: x.gender,
        Address: x.address,
        'Birth Date': formatDate(new Date(x.dob), 'yyyy-MM-dd', 'en') || '',
        'Blood Group': '',
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'gender':
          ...
          break;
        case 'date':
          [propertyA, propertyB] = [a.regTimestamp, b.regTimestamp];
          break;
        case 'address':
