...
export class DepartmentListComponent
  ...
  public loadData() {
    this.exampleDatabase = new DepartmentListService(this.httpClient, this.config);
  ...
  exportExcel() {
    ...
    const exportData: Partial<TableElement>[] =
      this.dataSource.filteredData.map((x) => ({
       'Department Number' : x.d_no,
        'Department Name': x.deptName,
        'Department Section': x.sectionName,
        Description: x.description,
        'Department Date': formatDate(new Date(x.d_date), 'yyyy-MM-dd', 'en') || '',
  ...
  sortData(data: DepartmentList[]): DepartmentList[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        case 'd_no':
          [propertyA, propertyB] = [a.deptId, b.deptId];
          break;
        case 'd_name':
          [propertyA, propertyB] = [a.deptName, b.deptName];
          break;
          case 'sectionName':
          [propertyA, propertyB] = [a.sectionName, b.sectionName];
          break;
        case 'status':
