...
@Component({
  selector: 'print-operation-summary',
  standalone: true,
  imports: [BreadcrumbComponent, MatButtonModule, FeatherIconsComponent, MatIconModule, NgxPrintModule, NgFor, CommonModule],
  templateUrl: './print-operation-summary.component.html',
  styleUrl: './print-operation-summary.component.scss'
})
export class PrintOperationSummary implements OnInit {

  @Input() appoinmentData!: any;
  @Input() operationSummaryData!: any;
  @Input() otRegistration!: any;
  hospitalId: any;

  constructor(public dialogRef: MatDialogRef<PrintOperationSummary>,
