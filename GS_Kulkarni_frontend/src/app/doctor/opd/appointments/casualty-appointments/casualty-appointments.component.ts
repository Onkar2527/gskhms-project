...
@Component({
  selector: 'app-casualty-appointments',
  templateUrl: './casualty-appointments.component.html',
  styleUrls: ['./casualty-appointments.component.scss'],
...
export class CasualtyAppointmentsComponent
  ...
  calcDateDiff(startDate : Date) {
    let endDate = new Date();
    var diff = endDate.getTime() - new Date(startDate).getTime();
    var days = Math.floor(diff / (60 * 60 * 24 * 1000));
    var hours = Math.floor(diff / (60 * 60 * 1000)) - (days * 24);
    var minutes = Math.floor(diff / (60 * 1000)) - ((days * 24 * 60) + (hours * 60));
    var seconds = Math.floor(diff / 1000) - ((days * 24 * 60 * 60) + (hours * 60 * 60) + (minutes * 60));
    return { hoursToDday: hours, minutesToDday: minutes, secondsToDday: seconds };
  }
