...
@Component({
  selector: 'app-disprescription',
  templateUrl: './disprescription.component.html',
  styleUrls: ['./disprescription.component.scss'],
  standalone: true,
  imports: [
    MatButtonModule,
    MatIconModule,
...
export class DisPrescriptionComponent implements OnInit{
  ...
  constructor(
    public dialogRef: MatDialogRef<DisPrescriptionComponent>,
  ...
  onSubmit() {
    this.masterService.savePrescriptionDetailsAfter(this.prescriptionDetailsAfter).subscribe((result: any) => {
      this.prescriptionDetailsAfter = null;
      this.loadTestDetails();
    });
  }
  ...
  addTemplateDetails(){
    ...
    .subscribe((res:any)=>{
      ...
      for(let obj of this.templatedet){
          ...
          this.prescriptionDetailsAfter.push(data);
  ...
  loadTestDetails(){
    ...
    this.prescriptionDetailsAfter = [];  
    this.masterService.getPrescriptionDetailsAfter(data).subscribe((res:any)=>{
  ...
  deleteTemplateDtl(obj: any){
    this.prescriptionDetailsAfter.splice(this.prescriptionDetailsAfter.indexOf(obj), 1);
  }
