...
import { CalendarService } from './ot-registration.service';
import {
  MatSnackBar,
...
import { OTRegistration } from './ot-registration.model';

@Component({
  selector: 'app-ot-registration',
  templateUrl: './ot-registration.component.html',
  styleUrls: ['./ot-registration.component.scss'],
  standalone: true,
  imports: [
    BreadcrumbComponent,
    MatButtonModule,
...
export class OTRegistrationComponent
  extends UnsubscribeOnDestroyAdapter
  implements OnInit {
  @ViewChild('calendar', { static: false })
  calendar: OTRegistration | null;
  public addCusForm: UntypedFormGroup;
  dialogTitle: string;
  filterOptions = 'All';
  calendarData!: OTRegistration;
  filterItems: string[] = [
    'work',
    'personal',
    'important',
  ...
  constructor(
    ...
    const blankObject = {} as OTRegistration;
    this.calendar = new OTRegistration(blankObject);
  ...
  editEvent(eventIndex: number, calendarData: OTRegistration) {
  ...
  createCalendarForm(calendar: OTRegistration): UntypedFormGroup {
