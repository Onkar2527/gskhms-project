...
@Component({
  selector: 'app-x-ray-registration-list',
  templateUrl: './x-ray-registration-list.component.html',
  styleUrls: ['./x-ray-registration-list.component.scss'],
...
export class XRayRegistrationListComponent
...
export class ExampleDataSource extends DataSource<Registration> {
  ...
  connect(): Observable<Registration[]> {
    ...
    this.exampleDatabase.getAllRegistration({type:'X', registrationStartDate: this.startDate, registrationEndDate: this.endDate});
