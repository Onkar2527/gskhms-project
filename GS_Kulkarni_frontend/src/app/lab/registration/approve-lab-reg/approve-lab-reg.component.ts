...
@Component({
  selector: 'approve-lab-reg',
  templateUrl: './approve-lab-reg.component.html',
  styleUrls: ['./approve-lab-reg.component.scss'],
...
export class ApproveLabRegComponent
...
export class ExampleDataSource extends DataSource<Registration> {
  ...
  connect(): Observable<Registration[]> {
    ...
    this.exampleDatabase.getAllRegistration({type:'T',approvalStatus:'A',status:"Report Generated", registrationStartDate: this.startDate, registrationEndDate: this.endDate});
