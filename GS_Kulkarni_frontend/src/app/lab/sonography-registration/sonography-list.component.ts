...
@Component({
  selector: 'app-sonography-registration-list',
  templateUrl: './sonography-list.component.html',
  styleUrls: ['./sonography-list.component.scss'],
...
export class SonographyRegistrationListComponent
...
export class ExampleDataSource extends DataSource<Registration> {
  ...
  connect(): Observable<Registration[]> {
    ...
    this.exampleDatabase.getAllRegistration({type:'Q', registrationStartDate: this.startDate, registrationEndDate: this.endDate});
