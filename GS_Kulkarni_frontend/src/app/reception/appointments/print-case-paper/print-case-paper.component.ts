...
@Component({
  selector: 'app-print-case-paper',
  standalone: true,
  imports: [BreadcrumbComponent, MatButtonModule, FeatherIconsComponent, MatIconModule, NgxPrintModule, NgFor, CommonModule],
  templateUrl: './print-case-paper.component.html',
  styleUrl: './print-case-paper.component.scss'
})
export class PrintCasePaperComponent implements OnInit {
