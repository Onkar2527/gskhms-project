...
@Component({
  selector: 'app-recommended-operations',
  templateUrl: './recommended-operations.component.html',
  styleUrls: ['./recommended-operations.component.scss'],
...
export class RecommendedOperationsComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit {
  displayedColumns = [
    'name',
    'mobileNumber',
  ...
  exportPDF() {
    ...
    const locale = 'en-US';
    TableExportUtil.exportToPDF(exportData, 'Recommended Operations For Dates: ' + formatDate(this.startDate, format, locale) + ' to ' + formatDate(this.endDate, format, locale));
  }
}
...
export class ExampleDataSource extends DataSource<Appointments> {
  ...
  connect(): Observable<Appointments[]> {
    ...
    appointment.operationRecommended = true;
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'operationDetails':
          [propertyA, propertyB] = [a.operationDetails, b.operationDetails];
          break;
