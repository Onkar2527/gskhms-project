...
import com.codecraft.master.services.impl.RoomService;
...
public class RoomController {
	...
	public ResponseEntity<MasterManagerResponse> search(@RequestBody Room room) {
		if (Objects.nonNull(room)) {
			return new ResponseEntity<>(roomService.search(room), HttpStatus.OK);
		} else {
	...
	@Operation(security = @SecurityRequirement(name = "bearerAuth"))
	public ResponseEntity<MasterManagerResponse> save(@RequestBody Room room) {
		return new ResponseEntity<>( roomService.save(room), HttpStatus.OK);
	}

	@PutMapping(value = "/room/update")
	@Operation(security = @SecurityRequirement(name = "bearerAuth"))
	public ResponseEntity<MasterManagerResponse> update(@RequestBody Room room) {
