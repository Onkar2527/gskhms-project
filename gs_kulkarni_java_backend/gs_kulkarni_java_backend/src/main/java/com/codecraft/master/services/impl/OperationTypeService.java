...
import com.codecraft.master.repositories.OperationTypeRepository;
...
public class OperationTypeService {
    ...
    public MasterManagerResponse search(OperationType reqDomain) {
        log.info("OperationTypeService : search() started reqDomain {}", reqDomain);
        try {
            List<OperationType> operationTypes = operationTypeRepository.findByHospitalId(UserContext.getHospitalId());
    ...
    @Transactional
    public MasterManagerResponse save(OperationType reqDomain) {
        ...
        try {
            ...
            return new MasterManagerResponse(MasterConstant.DATA_SAVED, operationTypeRepository.save(reqDomain));
        } catch (Exception e) {
    ...
    @Transactional
    public MasterManagerResponse update(OperationType reqDomain) {
